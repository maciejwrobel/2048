...
winsound.PlaySound("walczyk.wav", winsound.SND_ASYNC | winsound.SND_ALIAS)
...
class Game(tk.Frame):
    ...
    def start_game(self):
        #tworzenie podstawowej matrycy
        self.matrix = [[0] * 4 for _ in range(4)]
        #ustawienie 2 losowych dwójek
    ...
    #dodawanie nowego klocka 2 lub 4
    ...
    def game_over(self):
        if any(2048 in row for row in self.matrix):
            ...
            game_over_frame.place(relx=0.2, rely=0.07, anchor='center')
            tk.Label(
                game_over_frame,
                text="Nice !",
                bg=c.WINNER_BG,
